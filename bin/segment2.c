...
#if UNIVERSAL_CHARACTER_ICONS
    texture_hud_char_mushroom_1up,
#else
    texture_hud_char_mario_head,
#endif
    texture_hud_char_star, texture_hud_char_decimal_point, texture_hud_char_beta_key,
...
#if UNIVERSAL_CHARACTER_ICONS
    texture_hud_char_mario_cam,
#else
    texture_hud_char_mario_head,
#endif
    texture_hud_char_lakitu, texture_hud_char_no_camera,
